(function ($) {
  ...
  $(function () {
        ...
        datasets: [
          {
            ...
            backgroundColor: ["rgba(235, 105, 143, .7)"],
            borderColor: ["#eb698f"],
            borderWidth: 1,
            fill: "origin",
            label: "online",
          },
          {
            ...
            backgroundColor: ["rgba(119, 111, 249, .9)"],
            borderColor: ["#776ff9"],
            borderWidth: 1,
            fill: "origin",
            label: "store",
    ...
    if ($("#dashboard-monthly-analytics").length) {
      var ctx = document
        .getElementById("dashboard-monthly-analytics")
        .getContext("2d");
    ...
    if ($("#traffic-chart").length) {
      ...
      var gradientLegendRed =
        "linear-gradient(to right, rgba(238, 143, 154, 1), rgba(233, 79, 133, 1))";
        ...
        datasets: [
          {
            ...
            hoverBackgroundColor: [gradientStrokeBlue, gradientStrokeRed],
            borderColor: [gradientStrokeBlue, gradientStrokeRed],
            legendColor: [gradientLegendBlue, gradientLegendRed],
          },
        ],
          ...
          for (var i = 0; i < trafficChartData.datasets[0].data.length; i++) {
            text.push(
              '<li><h2 class="mb-3">' +
                ...
                '%</h2><div class="legend-content"><span class="legend-dots" style="background:' +
                trafficChartData.datasets[0].legendColor[i] +
                '"></span>' +
                trafficChartData.labels[i] +
                "</div>"
            );
            text.push("</li>");
          }
